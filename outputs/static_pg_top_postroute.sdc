################################################################################
#
# Design name:  static_pg_top
#
# Created by icc2 write_sdc on Sun Jun 28 20:55:45 2026
#
################################################################################
...
# /home/st160/VLSI-Project/vlsi-project/netlists/baseline/static_pg_top_lp.sdc, \
#   line 9
...
# -origin useful_skew
set_clock_latency -min 0.00028611 [get_clocks {clk}]
# -origin useful_skew
set_clock_latency -max 0.000305184 [get_clocks {clk}]
